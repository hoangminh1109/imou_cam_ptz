...
from .const import DEFAULT_TIMEOUT, MAX_RETRIES, PTZ_OPERATIONS
...
class ImouAPIClient:
    ...
    def __init__(self, base_url: str, app_id: str, app_secret: str, session: ClientSession) -> None:
        """
    ...
    async def async_api_getCollection(self, device_id: str, channel_id: str) -> dict:  # pylint: disable=invalid-name
        """Get the name information of the added favorites. \
            (https://open.imoulife.com/book/en/http/device/live/getCollection.html)."""
        # define the api endpoint
        api = "getCollection"
        # prepare the payload
        payload = {
    ...
    async def async_api_turnCollection(self, device_id: str, channel_id: str, name: str) -> dict:  # pylint: disable=invalid-name
        """Rotate the device to the target collection point. \
            (https://open.imoulife.com/book/en/http/device/live/turnCollection.html)."""
        # define the api endpoint
        api = "turnCollection"
        # prepare the payload
        payload = {
